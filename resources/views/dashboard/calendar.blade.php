    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
      ...
      <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
          <h1 class="text-3xl text-black pb-6">Appointment Calendar</h1>
                        ...
                        >
                          ...
                          >
                            <div
                              ...
                              :class="{'bg-yellow-500 text-white': isToday(date) == true, 'text-gray-700 hover:bg-yellow-200': isToday(date) == false }"
                            ></div>
                            <div
                              style="height: 80px"
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="mb-4">
                        ...
                        >
                        <input
                          class="bg-gray-200 appearance-none border-2 border-gray-200 rounded-lg w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-yellow-500"
                          type="text"
                          x-model="event_title"
                        />
                      </div>
                      ...
                      <div class="inline-block w-64 mb-4">
                        ...
                        <div class="relative">
                          <select
                            ...
                            x-model="event_theme"
                            class="block appearance-none w-full bg-gray-200 border-2 border-gray-200 hover:border-gray-500 px-4 py-2 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-yellow-500 text-gray-700"
                          >
                      ...
                      <div class="mt-8 text-right">
                        ...
                        <button
                          type="button"
                          class="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold py-2 px-4 border border-gray-700 rounded-lg shadow-sm"
                          @click="addEvent()"
                        >
                          Save Event
                        </button>
